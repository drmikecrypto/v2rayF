...
- GitHub push / public release only when the maintainer explicitly asks (authorized for **v2.6.2.15** Connect gate hotfix; **v2.6.2.16** probe fixes local-only until approved).
