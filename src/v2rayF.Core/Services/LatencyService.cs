...
public sealed class LatencyService
{
    ...
    /// <summary>
    /// Android VpnTunPathProbe / desktop WinTun: no VPN Network or <c>v2rayF</c> adapter (hard Connect fail).
    /// Distinct from -1 (VPN/adapter present, gen204/FCM miss — advisory only).
    /// </summary>
