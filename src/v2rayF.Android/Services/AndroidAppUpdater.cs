...
/// <summary>
/// Downloads the release zip, verifies SHA256, and installs the APK on top of the current app
/// via PackageInstaller (FileProvider fallback). Requires REQUEST_INSTALL_PACKAGES.
/// </summary>
